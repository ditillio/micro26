...
From these two equations, we see that for any price $P$, the quantity of policies demanded by group $B$ is exactly three times that demanded by group $A$. 
...
In other words, at any given price $P$, among the individuals willing to buy insurance, one in four is low-risk and three in four are high-risk. The average risk among the insured is therefore
$$
