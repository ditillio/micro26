...
Dalle due equazioni vediamo che, per qualunque prezzo $P$, la quantità di polizze domandata dal gruppo $B$ è esattamente il triplo di quella domandata dal gruppo $A$.
...
In altre parole, qualuque sia il prezzo $P$, tra gli individui disposti ad acquistare una polizza uno su quattro è a basso rischio, tre su quattro sono ad alto rischio. Il rischio medio tra gli assicurati è quindi
$$
